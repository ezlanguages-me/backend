...
BEGIN
    ...
    VALUES
        (v_item_id, 'es', 'Requisitos simples de trabajo', '{"scenario": "Trabajas en una pequeña oficina y necesitas pedir material para la próxima semana. Quieres practicar cómo decir cantidades, colores y fecha de entrega con claridad.", "tasks": ["Saluda y di el nombre de tu empresa o departamento.", "Explica qué producto necesitas.", "Di una cantidad exacta, por ejemplo 25 unidades.", "Añade un detalle como color, tamaño o modelo.", "Indica cuándo necesitas la entrega.", "Di a qué dirección o zona de trabajo debe llegar el pedido.", "Pregunta si el producto está disponible o si el proveedor puede confirmarlo.", "Cierra la petición con agradecimiento y una frase profesional."]}'::jsonb), (v_item_id, 'de', 'Einfache Arbeitsanforderungen', '{"scenario": "Du arbeitest in einem kleinen Büro und musst Material für die nächste Woche bestellen. Du möchtest üben, wie man Mengen, Farben und Lieferdaten klar nennt.", "tasks": ["Begrüße die Person und nenne deine Firma oder Abteilung.", "Erkläre, welches Produkt du brauchst.", "Nenne eine genaue Menge, zum Beispiel 25 Stück.", "Füge ein Detail wie Farbe, Größe oder Modell hinzu.", "Sag, wann du die Lieferung brauchst.", "Nenne die Adresse oder den Arbeitsbereich für die Lieferung.", "Frage, ob das Produkt verfügbar ist oder ob der Anbieter es bestätigen kann.", "Beende die Anfrage mit einem Dank und einem professionellen Satz."]}'::jsonb);
END;
$seed$;
