...
-- ============================================================
    ...
    DECLARE
        ...
        v_exercises JSONB[] := ARRAY[
            '{"p": "The dialogue is about whether remote lab sessions should stay after the pilot year.", "p_de": "The dialogue is about whether remote lab sessions should stay after the pilot year.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            ...
            '{"p": "Diego explains that supporters say recordings help students review procedures.", "p_de": "Diego explains that supporters say recordings help students review procedures.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            '{"p": "A counterpoint is that critics worry about weaker teamwork and slower troubleshooting.", "p_de": "A counterpoint is that critics worry about weaker teamwork and slower troubleshooting.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            ...
            '{"p": "What is the main focus?", "p_de": "What is the main focus?", "s": {"type": "multiple_choice", "options": ["whether remote lab sessions should stay after the pilot year", "a broken bus stop", "a lost suitcase"], "answer": 0}}'::jsonb,
            ...
            '{"p": "Which detail is named?", "p_de": "Which detail is named?", "s": {"type": "multiple_choice", "options": ["supporters say recordings help students review procedures", "the door is painted blue", "the train leaves at midnight"], "answer": 0}}'::jsonb,
            '{"p": "Which counterpoint appears?", "p_de": "Which counterpoint appears?", "s": {"type": "multiple_choice", "options": ["critics worry about weaker teamwork and slower troubleshooting", "nobody has a notebook", "the lesson is cancelled"], "answer": 0}}'::jsonb,
            '{"p": "What conclusion do the speakers reach?", "p_de": "What conclusion do the speakers reach?", "s": {"type": "multiple_choice", "options": ["the tutorial group supports blended labs rather than fully remote labs", "they forget the topic completely", "they decide to leave the room"], "answer": 0}}'::jsonb
        ];
    BEGIN
...
DELETE FROM writing WHERE step_order=8220 AND path_uuid=v_path_id;
        ...
        VALUES (v_path_id, 8220, 'en', 'dialogue', 'academic', '[{"name": "Sara", "gender": "female", "avatarURL": "https://example.com/avatars/sara.png"}, {"name": "Diego", "gender": "male", "avatarURL": "https://example.com/avatars/diego.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
        INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'Diálogo de tutoría');
        INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Tutoriumsdialog');
