-- ============================================================
-- Seed: A0 English Path – STEP 600 – Dialogue – express opinions in a limited way (Convivencia (Host Families y Vida Social))
...
BEGIN
  ...
  VALUES (v_path_uuid, 600, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'express opinions in a limited way (Convivencia (Host Families y Vida Social))', 'Práctica guiada de diálogo: express opinions in a limited way (Convivencia (Host Families y Vida Social)).');
