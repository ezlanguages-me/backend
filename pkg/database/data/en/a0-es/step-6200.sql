-- ============================================================
-- Seed: A0 English Path – STEP 6200 – Dialogue – take part in 'small talk' with peers (Convivencia (Host Families y Vida Social))
...
BEGIN
  ...
  VALUES (v_path_uuid, 6200, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'take part in ''small talk'' with peers (Convivencia (Host Families y Vida Social))', 'Práctica guiada de diálogo: take part in ''small talk'' with peers (Convivencia (Host Families y Vida Social)).');
