-- ============================================================
-- Seed: A0 English Path – STEP 7890 – Dialogue – answer predictable questions (Reuniones y Presentaciones)
...
BEGIN
  ...
  VALUES (v_path_uuid, 7890, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'answer predictable questions (Reuniones y Presentaciones)', 'Práctica guiada de diálogo: answer predictable questions (Reuniones y Presentaciones).');
