-- ============================================================
-- Seed: A0 English Path – STEP 5460 – Dialogue – ask simple questions and understand simple answers (Conferencias, Seminarios y Clases)
...
BEGIN
  ...
  VALUES (v_path_uuid, 5460, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'ask simple questions and understand simple answers (Conferencias, Seminarios y Clases)', 'Práctica guiada de diálogo: ask simple questions and understand simple answers (Conferencias, Seminarios y Clases).');
