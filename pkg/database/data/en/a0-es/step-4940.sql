-- ============================================================
-- Seed: A0 English Path – STEP 4940 – Dialogue – understand 1 or 2 word answers (Conferencias, Seminarios y Clases)
...
BEGIN
  ...
  VALUES (v_path_uuid, 4940, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'understand 1 or 2 word answers (Conferencias, Seminarios y Clases)', 'Práctica guiada de diálogo: understand 1 or 2 word answers (Conferencias, Seminarios y Clases).');
