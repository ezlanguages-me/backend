...
BEGIN
  ...
  VALUES (v_path_uuid, 260, 'en')
  RETURNING uuid INTO v_reading_uuid;

  INSERT INTO reading_translation (reading_uuid, language, title, description, content)
  VALUES (v_reading_uuid, 'es', 'understand simple information, for example, from a prospective pen friend (Comunicación Telefónica y Correspondencia Personal)', 'Práctica guiada de reading: understand simple information, for example, from a prospective pen friend (Comunicación Telefónica y Correspondencia Personal).', '{"instruction":"understand simple information, for example, from a prospective pen friend (Comunicación Telefónica y Correspondencia Personal)","passage":"Reading content pending.","notes":"Contenido pendiente."}'::jsonb);
END;
$seed$;
