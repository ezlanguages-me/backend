...
-- ============================================================
    ...
    DECLARE
        ...
        v_exercises JSONB[] := ARRAY[
            '{"p": "The dialogue is about an attendance policy that rewards preparation rather than simple presence.", "p_de": "The dialogue is about an attendance policy that rewards preparation rather than simple presence.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            ...
            '{"p": "Diego explains that survey data show students participate more after writing short prep notes.", "p_de": "Diego explains that survey data show students participate more after writing short prep notes.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            '{"p": "A counterpoint is that some students worry about extra weekly workload.", "p_de": "A counterpoint is that some students worry about extra weekly workload.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            ...
            '{"p": "What is the main focus?", "p_de": "What is the main focus?", "s": {"type": "multiple_choice", "options": ["an attendance policy that rewards preparation rather than simple presence", "a broken bus stop", "a lost suitcase"], "answer": 0}}'::jsonb,
            ...
            '{"p": "Which detail is named?", "p_de": "Which detail is named?", "s": {"type": "multiple_choice", "options": ["survey data show students participate more after writing short prep notes", "the door is painted blue", "the train leaves at midnight"], "answer": 0}}'::jsonb,
            '{"p": "Which counterpoint appears?", "p_de": "Which counterpoint appears?", "s": {"type": "multiple_choice", "options": ["some students worry about extra weekly workload", "nobody has a notebook", "the lesson is cancelled"], "answer": 0}}'::jsonb,
            '{"p": "What conclusion do the speakers reach?", "p_de": "What conclusion do the speakers reach?", "s": {"type": "multiple_choice", "options": ["the discussion supports a small graded preparation note", "they forget the topic completely", "they decide to leave the room"], "answer": 0}}'::jsonb
        ];
    BEGIN
...
DELETE FROM writing WHERE step_order=8330 AND path_uuid=v_path_id;
        ...
        VALUES (v_path_id, 8330, 'en', 'dialogue', 'academic', '[{"name": "Sara", "gender": "female", "avatarURL": "https://example.com/avatars/sara.png"}, {"name": "Diego", "gender": "male", "avatarURL": "https://example.com/avatars/diego.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
        INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'express and justify opinions');
        INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'express and justify opinions');
