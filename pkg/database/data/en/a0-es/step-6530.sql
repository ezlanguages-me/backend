...
DECLARE
    ...
    v_exercises JSONB[] := ARRAY[
        '{"p": "The dialogue is about a day in Port Vista.", "p_de": "The dialogue is about a day in Port Vista.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "The first speaker asks about the sightseeing plan.", "p_de": "The first speaker asks about the sightseeing plan.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        '{"p": "The second speaker says they buy the day pass first.", "p_de": "The second speaker says they buy the day pass first.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "What is the main purpose of the dialogue?", "p_de": "What is the main purpose of the dialogue?", "s": {"type": "multiple_choice", "options": ["the sightseeing plan", "buy a tractor", "find a lost camel"], "answer": 0}}'::jsonb,
        '{"p": "How does the dialogue end?", "p_de": "How does the dialogue end?", "s": {"type": "multiple_choice", "options": ["with a clear meeting plan", "with a big argument", "with no clear plan"], "answer": 0}}'::jsonb
    ];
BEGIN
    ...
    VALUES (v_path_id, 6530, 'en', 'dialogue', 'tourism', '[{"name":"Ana","gender":"female","avatarURL":"https://example.com/avatars/ana.png"},{"name":"Leo","gender":"male","avatarURL":"https://example.com/avatars/leo.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'Planear un día en Port Vista');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Tag in Port Vista planen');
