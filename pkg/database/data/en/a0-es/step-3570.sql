-- ============================================================
-- Seed: A0 English Path – STEP 3570 – Dialogue – book a room in a hotel over the phone (Alojamiento)
...
BEGIN
  ...
  VALUES (v_path_uuid, 3570, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'book a room in a hotel over the phone (Alojamiento)', 'Práctica guiada de diálogo: book a room in a hotel over the phone (Alojamiento).');
