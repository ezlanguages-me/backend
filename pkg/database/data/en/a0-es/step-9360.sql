...
BEGIN
  ...
  VALUES (v_path_uuid, 9360, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'take an active part in most kinds of seminars or tutorials (Conferencias, Seminarios y Clases)', 'Práctica guiada de diálogo: take an active part in most kinds of seminars or tutorials (Conferencias, Seminarios y Clases).');
