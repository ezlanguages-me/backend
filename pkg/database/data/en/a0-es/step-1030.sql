...
DECLARE
    ...
    v_exercises JSONB[] := ARRAY[
        ...
        '{"es": "¿Qué archivo descargan?", "de": "Welche Datei laden sie herunter?", "s_es": {"type": "multiple_choice", "options": ["File B", "File C", "File A"], "answer": 2}, "s_de": {"type": "multiple_choice", "options": ["Datei B", "Datei C", "Datei A"], "answer": 2}}'::jsonb,
        '{"es": "¿Con quién trabajan?", "de": "Mit wem arbeiten sie?", "s_es": {"type": "multiple_choice", "options": ["With the librarian", "With a partner", "With the principal"], "answer": 1}, "s_de": {"type": "multiple_choice", "options": ["Mit der Bibliothekarin", "Mit einem Partner", "Mit dem Direktor"], "answer": 1}}'::jsonb,
        ...
        '{"es": "¿Dónde ponen la página impresa?", "de": "Wohin legen sie die gedruckte Seite?", "s_es": {"type": "multiple_choice", "options": ["On the teachers chair", "Under the keyboard", "In the green box near the window"], "answer": 2}, "s_de": {"type": "multiple_choice", "options": ["Auf den Stuhl der Lehrerin", "Unter die Tastatur", "In die grüne Box am Fenster"], "answer": 2}}'::jsonb,
        '{"es": "¿Con quién hablan si la impresora se para?", "de": "Mit wem sprechen sie, wenn der Drucker stehen bleibt?", "s_es": {"type": "multiple_choice", "options": ["Mr Green", "Ms Brown", "The security guard"], "answer": 1}, "s_de": {"type": "multiple_choice", "options": ["Mit Mr Green", "Mit Ms Brown", "Mit dem Wachmann"], "answer": 1}}'::jsonb,
        ...
        '{"es": "¿Hasta qué hora está la lista en el tablón?", "de": "Bis wann bleibt die Liste am Brett?", "s_es": {"type": "multiple_choice", "options": ["2 PM", "5 PM", "6 PM"], "answer": 1}, "s_de": {"type": "multiple_choice", "options": ["14 Uhr", "17 Uhr", "18 Uhr"], "answer": 1}}'::jsonb
    ];
BEGIN
    ...
    VALUES (v_path_id, 1030, 'en', 'reading', 'academic', 'Dear students,\n\nTomorrow we meet in Science Building 4 at 2 PM for the workshop. Please come on time. When you arrive, put your coat on the back shelf near the door.\n\nTake one blue worksheet from the front table. Each person takes one sheet only. The sheet is blue, not yellow or green.\n\nFirst, write your name and your group number on the sheet. Then open the class website on the computer and download File A. Work with your partner at Computer 6 or Computer 7. You do not work alone at this activity.\n\nAfter you finish the activity, print one page and put it in the green box near the window. If the printer stops, speak to Ms Brown at Desk 1. She will help you.\n\nBefore you leave, sign up for next week office hour on the paper list on the notice board. The list stays on the board until 5 PM. Please add your name before then.')RETURNING uuid INTO v_reading_id;

    INSERT INTO reading_translation (reading_uuid, language, title)
    VALUES
        (v_reading_id, 'es', 'Todas las indicaciones'), (v_reading_id, 'de', 'Praktischen Studienhinweise');
