-- ============================================================
-- Seed: A0 English Path – STEP 2670 – Dialogue – ask over the phone for a medical appointment and understand the reply (Salud)
...
BEGIN
  ...
  VALUES (v_path_uuid, 2670, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'ask over the phone for a medical appointment and understand the reply (Salud)', 'Práctica guiada de diálogo: ask over the phone for a medical appointment and understand the reply (Salud).');
