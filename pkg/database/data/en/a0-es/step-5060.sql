...
BEGIN
    ...
    VALUES (v_path_id, 5060, 'en', 'dialogue', 'academic', '[{"name": "Student", "gender": "female", "avatarURL": "https://example.com/avatars/student.png"}, {"name": "Professor", "gender": "male", "avatarURL": "https://example.com/avatars/professor.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES (v_dialogue_id, 'es', 'Pedir aclaraciones en clase');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES (v_dialogue_id, 'de', 'Unterricht um Klärung bitten');
