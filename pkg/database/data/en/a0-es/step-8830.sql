...
BEGIN
  ...
  VALUES (v_path_uuid, 8830, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'argue/complain effectively about most problem areas that are likely to occur (Alquileres)', 'Práctica guiada de diálogo: argue/complain effectively about most problem areas that are likely to occur (Alquileres).');
