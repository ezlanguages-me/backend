-- ============================================================
-- Seed: A0 English Path – STEP 3010 – Dialogue – understand basic information such as cost per hour/day (Viajes y Transporte)
...
BEGIN
  ...
  VALUES (v_path_uuid, 3010, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'understand basic information such as cost per hour/day (Viajes y Transporte)', 'Práctica guiada de diálogo: understand basic information such as cost per hour/day (Viajes y Transporte).');
