...
BEGIN
    ...
    VALUES (v_path_id, 6960, 'en', 'speaking', 'media')RETURNING uuid INTO v_speaking_id;
    INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
    VALUES (v_speaking_id, 'es', 'Describir un programa de TV', '{"scenario": "Quieres hablar sobre un tema de medios: a TV programme.", "tasks": ["Di el tema principal.", "Di dónde o en qué programa aparece.", "Di una hora o momento.", "Menciona a una persona importante.", "Explica un detalle.", "Da una opinión simple.", "Di por qué es interesante.", "Haz un cierre breve y claro."]}'::jsonb);
    INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
    VALUES (v_speaking_id, 'de', 'Fernsehsendung beschreiben', '{"scenario": "Du möchtest über ein Medienthema sprechen: eine Fernsehsendung.", "tasks": ["Nenne das Hauptthema.", "Sage, wo oder in welcher Sendung es vorkommt.", "Nenne eine Uhrzeit oder einen Zeitpunkt.", "Nenne eine wichtige Person.", "Erkläre ein Detail.", "Gib eine einfache Meinung.", "Sage, warum es interessant ist.", "Schließe kurz und klar ab."]}'::jsonb);
END; $seed$;
