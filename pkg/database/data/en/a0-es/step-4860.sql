-- ============================================================
-- Seed: A0 English Path – STEP 4860 – Dialogue – use the telephone for most purposes (Teléfono Profesional)
...
BEGIN
  ...
  VALUES (v_path_uuid, 4860, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'use the telephone for most purposes (Teléfono Profesional)', 'Práctica guiada de diálogo: use the telephone for most purposes (Teléfono Profesional).');
