-- ============================================================
-- Seed: A0 English Path – STEP 3790 – Dialogue – state simple requirements within own job area, for example 'I want to order 25 of
...
BEGIN
  ...
  VALUES (v_path_uuid, 3790, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'state simple requirements within own job area, for example ''I want to order 25 of', 'Práctica guiada de diálogo: state simple requirements within own job area, for example ''I want to order 25 of.');
