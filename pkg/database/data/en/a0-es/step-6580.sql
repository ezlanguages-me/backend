-- ============================================================
-- Seed: A0 English Path – STEP 6580 – Dialogue – understand most of what is said on most guided tours (Turismo y Entretenimiento)
...
BEGIN
  ...
  VALUES (v_path_uuid, 6580, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'understand most of what is said on most guided tours (Turismo y Entretenimiento)', 'Práctica guiada de diálogo: understand most of what is said on most guided tours (Turismo y Entretenimiento).');
