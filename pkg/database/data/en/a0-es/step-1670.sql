...
BEGIN
    ...
    VALUES (v_path_id, 1670, 'en', 'dialogue', 'transport', '[{"name": "Passenger", "gender": "neutral", "avatarURL": "https://example.com/avatars/passenger.png"}, {"name": "Clerk", "gender": "female", "avatarURL": "https://example.com/avatars/clerk.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', '¿Qué autobús va al estadio?');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Welcher Bus fährt zum Stadion?');
