-- ============================================================
-- Seed: A0 English Path – STEP 5420 – Dialogue – give a clear presentation on a familiar topic, and CAN answer predictable or factual questions (Conferencias, Seminarios y Clases)
...
BEGIN
  ...
  VALUES (v_path_uuid, 5420, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'give a clear presentation on a familiar topic, and CAN answer predictable or factual questions (Conferencias, Seminarios y Clases)', 'Práctica guiada de diálogo: give a clear presentation on a familiar topic, and CAN answer predictable or factual questions (Conferencias, Seminarios y Clases).');
