-- ============================================================
-- Seed: A0 English Path – STEP 6100 – Dialogue – Can state requirements, e.g. installing a telephone (Alquileres)
...
BEGIN
  ...
  VALUES (v_path_uuid, 6100, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'Can state requirements, e.g. installing a telephone (Alquileres)', 'Práctica guiada de diálogo: Can state requirements, e.g. installing a telephone (Alquileres).');
