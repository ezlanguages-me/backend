-- ============================================================
-- Seed: A0 English Path – STEP 8750 – Dialogue – bargain for what (s)he wants and reach an agreement (Compras y Transacciones)
...
BEGIN
  ...
  VALUES (v_path_uuid, 8750, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'bargain for what (s)he wants and reach an agreement (Compras y Transacciones)', 'Práctica guiada de diálogo: bargain for what (s)he wants and reach an agreement (Compras y Transacciones).');
