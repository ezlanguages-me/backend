-- ============================================================
-- Seed: A0 English Path – STEP 3230 – Dialogue – call an emergency number, give location and ask for relevant service (Emergencias)
...
BEGIN
  ...
  VALUES (v_path_uuid, 3230, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'call an emergency number, give location and ask for relevant service (Emergencias)', 'Práctica guiada de diálogo: call an emergency number, give location and ask for relevant service (Emergencias).');
