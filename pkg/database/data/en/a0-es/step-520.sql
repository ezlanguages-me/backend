...
BEGIN
  ...
  VALUES (v_path_uuid, 520, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'make a simple complaint, for example ''The cooker is broken. Can you replace it?'' (Alquileres)', 'Práctica guiada de diálogo: make a simple complaint, for example ''The cooker is broken. Can you replace it?'' (Alquileres).');
