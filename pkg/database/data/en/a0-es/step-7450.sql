-- ============================================================
-- Seed: A0 English Path – STEP 7450 – Dialogue – understand most of what takes place (Reuniones y Presentaciones)
...
BEGIN
  ...
  VALUES (v_path_uuid, 7450, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'understand most of what takes place (Reuniones y Presentaciones)', 'Práctica guiada de diálogo: understand most of what takes place (Reuniones y Presentaciones).');
