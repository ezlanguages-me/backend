...
DELETE FROM writing WHERE step_order=8450 AND path_uuid=v_path_id;
        ...
        VALUES (v_path_id,8450,'en','listening','academic',$transcript$# AUDIO PROFILE
...
[warm] Guest: As the speaker says, "A good follow-up question opens the next layer of detail."$transcript$)
        ...
        INSERT INTO listening_translation (listening_uuid,language,title,description) VALUES (v_listening_id,'es','follow complex Q&A exchange','Escucha el audio y responde.');
        INSERT INTO listening_translation (listening_uuid,language,title,description) VALUES (v_listening_id,'de','follow complex Q&A exchange','Höre das Audio und beantworte die Fragen.');
