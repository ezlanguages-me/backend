-- ============================================================
-- Seed: A0 English Path – STEP 3640 – Dialogue – CAN, on arrival in a foreign country, answer routine questions such as 'How long are you staying?' and respond appropriately (Viajes y Transporte)
...
BEGIN
  ...
  VALUES (v_path_uuid, 3640, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'CAN, on arrival in a foreign country, answer routine questions such as ''How long are you staying?'' and respond appropriately (Viajes y Transporte)', 'Práctica guiada de diálogo: CAN, on arrival in a foreign country, answer routine questions such as ''How long are you staying?'' and respond appropriately (Viajes y Transporte).');
