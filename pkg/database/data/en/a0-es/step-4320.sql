...
BEGIN
    ...
    VALUES (v_path_id, 4320, 'en', 'dialogue', 'professional', '[{"name": "Manager", "gender": "female", "avatarURL": "https://example.com/avatars/manager.png"}, {"name": "Assistant", "gender": "male", "avatarURL": "https://example.com/avatars/assistant.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES
        (v_dialogue_id, 'es', 'Practica dictado y aclaración'), (v_dialogue_id, 'de', 'Übe Diktat und Klärung');
