...
BEGIN
    ...
    VALUES (v_path_id, 2710, 'en', 'dialogue', 'health', '[{"name": "Patient", "gender": "neutral", "avatarURL": "https://example.com/avatars/patient.png"}, {"name": "Pharmacist", "gender": "female", "avatarURL": "https://example.com/avatars/pharmacist.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES
        (v_dialogue_id, 'es', 'Tomar un medicamento'), (v_dialogue_id, 'de', 'Frage, wie man ein Medikament');
