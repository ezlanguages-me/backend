-- ============================================================
-- Seed: A0 English Path – STEP 6460 – Dialogue – give simple explanations about familiar places (Turismo y Entretenimiento)
...
BEGIN
  ...
  VALUES (v_path_uuid, 6460, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'give simple explanations about familiar places (Turismo y Entretenimiento)', 'Práctica guiada de diálogo: give simple explanations about familiar places (Turismo y Entretenimiento).');
