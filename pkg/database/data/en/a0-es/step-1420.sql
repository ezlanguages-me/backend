...
BEGIN
  ...
  VALUES (v_path_uuid, 1420, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'ask to open an account at a bank provided that the procedure is straightforward (Servicios Financieros y Postales)', 'Práctica guiada de diálogo: ask to open an account at a bank provided that the procedure is straightforward (Servicios Financieros y Postales).');
