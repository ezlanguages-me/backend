...
BEGIN
    ...
    VALUES (v_path_id,6490,'en','listening','tourism',$transcript$# AUDIO PROFILE
...
$transcript$)
    ...
    INSERT INTO listening_translation (listening_uuid,language,title,description) VALUES (v_listening_id,'es','Información turística sobre Port Vista','Escucha la información turística y responde.');
    INSERT INTO listening_translation (listening_uuid,language,title,description) VALUES (v_listening_id,'de','Touristeninformation zu Port Vista','Höre die Touristeninformation und antworte.');
