...
BEGIN
  ...
  VALUES (v_path_uuid, 2300, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'order a meal and ask for clarification about dishes on the menu (Restauración)', 'Práctica guiada de diálogo: order a meal and ask for clarification about dishes on the menu (Restauración).');
