-- ============================================================
-- Seed: A0 English Path – STEP 7810 – Dialogue – ask for factual information and understand the answer (Reuniones y Presentaciones)
...
BEGIN
  ...
  VALUES (v_path_uuid, 7810, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'ask for factual information and understand the answer (Reuniones y Presentaciones)', 'Práctica guiada de diálogo: ask for factual information and understand the answer (Reuniones y Presentaciones).');
