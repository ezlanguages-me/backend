...
BEGIN
    ...
    INSERT INTO reading_translation (reading_uuid,language,title,description) VALUES (v_reading_id,'es','Folleto de Port Vista','Lee el folleto de la ciudad y responde.');
    INSERT INTO reading_translation (reading_uuid,language,title,description) VALUES (v_reading_id,'de','Flyer zu Port Vista','Lies den Stadtflyer und antworte.');
