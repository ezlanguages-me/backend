...
BEGIN
    ...
    VALUES (v_path_id,7160,'en','listening','phone_correspondence',$transcript$# AUDIO PROFILE
...
$transcript$)
    ...
    INSERT INTO listening_translation (listening_uuid,language,title,description) VALUES (v_listening_id,'es','Llamada sobre preparativos','Escucha la llamada y responde.');
    INSERT INTO listening_translation (listening_uuid,language,title,description) VALUES (v_listening_id,'de','Telefonat über Absprachen','Höre das Telefonat und antworte.');
