...
DELETE FROM writing WHERE step_order=8190 AND path_uuid=v_path_id;
        ...
        VALUES (v_path_id,8190,'en','reading','academic','Read Arguments And Counterarguments
...
In the end, the writer argues that the tutorial group supports blended labs rather than fully remote labs. The closing line states, "A defendable position responds to the other side."')
        ...
        INSERT INTO reading_translation (reading_uuid,language,title,description) VALUES (v_reading_id,'es','read arguments and counterarguments','Lee el texto y responde.');
        INSERT INTO reading_translation (reading_uuid,language,title,description) VALUES (v_reading_id,'de','read arguments and counterarguments','Lies den Text und beantworte die Fragen.');
