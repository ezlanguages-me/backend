...
BEGIN
    ...
    VALUES (v_path_id, 6550, 'en', 'reading', 'tourism', 'Programme: Summer Lights Concert\n\nSummer Lights Concert is at Riverside Hall on Saturday at 19:30.\n\nThe programme includes Mila Stone and the Moon Band. The event lasts two hours and tickets cost 18 euros.\n\nThere is one short interval. Visitors should arrive ten minutes early.')RETURNING uuid INTO v_reading_id;
    INSERT INTO reading_translation (reading_uuid, language, title) VALUES (v_reading_id, 'es', 'Programa de Summer Lights');
    INSERT INTO reading_translation (reading_uuid, language, title) VALUES (v_reading_id, 'de', 'Programm von Summer Lights');
