...
BEGIN
  ...
  VALUES (v_path_uuid, 2020, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'ask simple questions about the menu and understand simple answers (Restauración)', 'Práctica guiada de diálogo: ask simple questions about the menu and understand simple answers (Restauración).');
