-- ============================================================
-- Seed: A0 English Path – STEP 1630 – Dialogue – understand simple directions, e.g. 'turn left at the end of the road' (Viajes y Transporte)
...
BEGIN
  ...
  VALUES (v_path_uuid, 1630, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'understand simple directions, e.g. ''turn left at the end of the road'' (Viajes y Transporte)', 'Práctica guiada de diálogo: understand simple directions, e.g. ''turn left at the end of the road'' (Viajes y Transporte).');
