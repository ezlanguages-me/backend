...
DECLARE
    ...
    v_exercises JSONB[] := ARRAY[
        '{"p": "The dialogue is about Luna City.", "p_de": "The dialogue is about Luna City.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "The first speaker asks about the brochure plan.", "p_de": "The first speaker asks about the brochure plan.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        '{"p": "The second speaker says they visit Green Hill Park first.", "p_de": "The second speaker says they visit Green Hill Park first.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "Which place is mentioned?", "p_de": "Which place is mentioned?", "s": {"type": "multiple_choice", "options": ["the tourist office", "the airport tunnel", "the desert farm"], "answer": 0}}'::jsonb,
        '{"p": "What is the main purpose of the dialogue?", "p_de": "What is the main purpose of the dialogue?", "s": {"type": "multiple_choice", "options": ["the brochure plan", "buy a tractor", "find a lost camel"], "answer": 0}}'::jsonb,
        '{"p": "How does the dialogue end?", "p_de": "How does the dialogue end?", "s": {"type": "multiple_choice", "options": ["with the day organised", "with a big argument", "with no clear plan"], "answer": 0}}'::jsonb
    ];
BEGIN
    ...
    VALUES (v_path_id, 6720, 'en', 'dialogue', 'tourism', '[{"name":"Ana","gender":"female","avatarURL":"https://example.com/avatars/ana.png"},{"name":"Leo","gender":"male","avatarURL":"https://example.com/avatars/leo.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'Hablar sobre Luna City');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Über Luna City sprechen');
