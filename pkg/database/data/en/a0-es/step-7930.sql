-- ============================================================
-- Seed: A0 English Path – STEP 7930 – Dialogue – deal with unpredictable questions (Reuniones y Presentaciones)
...
BEGIN
  ...
  VALUES (v_path_uuid, 7930, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'deal with unpredictable questions (Reuniones y Presentaciones)', 'Práctica guiada de diálogo: deal with unpredictable questions (Reuniones y Presentaciones).');
