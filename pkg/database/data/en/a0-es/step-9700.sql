...
BEGIN
  ...
  VALUES (v_path_uuid, 9700, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'get the point of jokes or allusions with cultural content (Conferencias, Seminarios y Clases)', 'Práctica guiada de diálogo: get the point of jokes or allusions with cultural content (Conferencias, Seminarios y Clases).');
