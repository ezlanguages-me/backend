...
BEGIN
  ...
  VALUES (v_path_uuid, 1050, 'en')
  RETURNING uuid INTO v_writing_uuid;

  INSERT INTO writing_translation (writing_uuid, language, title, description, prompt)
  VALUES (v_writing_uuid, 'es', 'note down times, dates and places given by teachers and lecturers (Gestión del Estudio y Trámites)', 'Práctica guiada de writing: note down times, dates and places given by teachers and lecturers (Gestión del Estudio y Trámites).', '{"instruction":"note down times, dates and places given by teachers and lecturers (Gestión del Estudio y Trámites)","context":"Contenido pendiente.","language":"es"}'::jsonb);
END;
$seed$;
