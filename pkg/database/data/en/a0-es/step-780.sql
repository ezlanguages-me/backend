...
DECLARE
  ...
  ex JSONB;
    v_exercises JSONB[] := ARRAY[
        ...
        -- MC: 0,2,1,0,2,1,0,1,2 = {0:3,1:3,2:3}
        ...
        '{"p": "¿Qué necesita Anna?", "p_de": "Was braucht Anna?", "s_es": {"type": "multiple_choice", "options": ["La factura final", "La clave del wifi", "La nueva lista de precios"], "answer": 2}, "s_de": {"type": "multiple_choice", "options": ["Die Schlussrechnung", "Das WLAN-Passwort", "Die neue Preisliste"], "answer": 2}}'::jsonb,
        '{"p": "¿Cuándo es ahora la reunión con Green Hotel?", "p_de": "Wann ist jetzt das Treffen mit dem Green Hotel?", "s_es": {"type": "multiple_choice", "options": ["El jueves a las 3 PM", "El martes a las 3 PM", "El martes a las 10 AM"], "answer": 1}, "s_de": {"type": "multiple_choice", "options": ["Am Donnerstag um 15 Uhr", "Am Dienstag um 15 Uhr", "Am Dienstag um 10 Uhr"], "answer": 1}}'::jsonb,
        ...
        '{"p": "¿Desde dónde llamó Helen White?", "p_de": "Von wo hat Helen White angerufen?", "s_es": {"type": "multiple_choice", "options": ["Desde recepción", "Desde un hotel", "Desde el aeropuerto"], "answer": 2}, "s_de": {"type": "multiple_choice", "options": ["Von der Rezeption", "Von einem Hotel", "Vom Flughafen"], "answer": 2}}'::jsonb,
        '{"p": "¿Qué tienes que empezar a las 2 PM?", "p_de": "Was musst du um 14 Uhr beginnen?", "s_es": {"type": "multiple_choice", "options": ["La reunión de HR", "La visita del cliente", "La llamada de IT"], "answer": 1}, "s_de": {"type": "multiple_choice", "options": ["Das HR-Treffen", "Den Kundentermin", "Den IT-Anruf"], "answer": 1}}'::jsonb,
        ...
        '{"p": "¿Cuántas cajas trae la entrega?", "p_de": "Wie viele Kartons bringt die Lieferung?", "s_es": {"type": "multiple_choice", "options": ["Una caja", "Tres cajas", "Cinco cajas"], "answer": 1}, "s_de": {"type": "multiple_choice", "options": ["Einen Karton", "Drei Kartons", "Fünf Kartons"], "answer": 1}}'::jsonb,
        '{"p": "¿Qué está listo antes de las 5 PM?", "p_de": "Was ist vor 17 Uhr fertig?", "s_es": {"type": "multiple_choice", "options": ["La sala de formación", "El correo electrónico", "Tu teléfono"], "answer": 2}, "s_de": {"type": "multiple_choice", "options": ["Der Schulungsraum", "Die E-Mail", "Dein Telefon"], "answer": 2}}'::jsonb
    ];
BEGIN
...
She needs the new price list by the end of the day.
She said the old version has some errors.
Please call her back at 555-0141 as soon as possible.

10:00 AM — Mr Gomez from Green Hotel called.
The meeting is now on Tuesday at 3 PM, not on Monday.
He will also send a confirmation by email.
Please check your inbox and reply to confirm the change.

11:25 AM — Lisa from HR called.
The training room is free after lunch today, not before.
She needs your final list of names for the new staff folder.
Please send the list to her email before 3 PM if possible.

1:15 PM — Helen White called from the airport.
Her flight was delayed and she is running late.
Please start the client visit at 2 PM without her.
She will join the meeting online from the departure lounge.

2:40 PM — A delivery driver is outside the back door with three boxes.
He cannot get in without someone to open the door.
Please call reception on extension 12 to let him in.

4:05 PM — Sam from IT left a message.
Your new phone is set up and ready to collect.
Please pick it up from the IT room before 5 PM.
After 5 PM the IT room will be locked for the evening.$content$
  ) RETURNING uuid INTO v_reading_uuid;

  INSERT INTO reading_translation (reading_uuid, language, title)
  VALUES (v_reading_uuid, 'es', 'Mensajes telefónicos de oficina');

  INSERT INTO reading_translation (reading_uuid, language, title)
  VALUES (v_reading_uuid, 'de', 'Telefonnotizen im Büro');
