...
BEGIN
    ...
    VALUES (v_path_id,6600,'en','reading','tourism','FAQ: Colors of the Sea Exhibition\n\nQ: Where does the visit begin? A: It begins at the blue desk at 12:00 in the City Art Centre.\n\nQ: What can people see? A: They can see Wave Window and the shell room. The visit lasts 35 minutes and costs 9 euros.\n\nQ: What is a good tip? A: ask for the blue map. The education desk is close after the visit.')
    RETURNING uuid INTO v_reading_id;
    INSERT INTO reading_translation (reading_uuid,language,title,description) VALUES (v_reading_id,'es','Preguntas frecuentes para Colors of the Sea','Lee las aclaraciones y responde.');
    INSERT INTO reading_translation (reading_uuid,language,title,description) VALUES (v_reading_id,'de','Häufige Fragen zu Colors of the Sea','Lies die Erklärungen und antworte.');
