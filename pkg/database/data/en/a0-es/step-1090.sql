...
BEGIN
  ...
  VALUES (v_path_uuid, 1090, 'en', 'grammar')
  ...
  VALUES (
    v_grammar_uuid,
    'es',
    'Preposiciones (In, On, At para tiempo y lugar)',
    'Punto gramatical base: Preposiciones (In, On, At para tiempo y lugar).',
    to_jsonb($content$# Preposiciones (In, On, At para tiempo y lugar)
