...
BEGIN
  ...
  VALUES (v_path_uuid, 840, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'make an outgoing call and pass on simple, prepared messages (Teléfono Profesional)', 'Práctica guiada de diálogo: make an outgoing call and pass on simple, prepared messages (Teléfono Profesional).');
