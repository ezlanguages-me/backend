-- ============================================================
-- Seed: A0 English Path – STEP 6870 – Dialogue – follow the plot of a film or play where action clearly illustrates the dialogue, for example a 'western' (Medios de Comunicación)
...
BEGIN
  ...
  VALUES (v_path_uuid, 6870, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'follow the plot of a film or play where action clearly illustrates the dialogue, for example a ''western'' (Medios de Comunicación)', 'Práctica guiada de diálogo: follow the plot of a film or play where action clearly illustrates the dialogue, for example a ''western'' (Medios de Comunicación).');
