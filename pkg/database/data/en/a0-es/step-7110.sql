...
BEGIN
    ...
    INSERT INTO reading_translation (reading_uuid,language,title,description) VALUES (v_reading_id,'es','Correo personal de Ana','Lee el correo personal y responde.');
    INSERT INTO reading_translation (reading_uuid,language,title,description) VALUES (v_reading_id,'de','Persönliche E-Mail von Ana','Lies die persönliche E-Mail und antworte.');
