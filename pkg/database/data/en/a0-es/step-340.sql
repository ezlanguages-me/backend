...
BEGIN
  ...
  VALUES (v_path_uuid, 340, 'en')
  RETURNING uuid INTO v_reading_uuid;

  INSERT INTO reading_translation (reading_uuid, language, title, description, content)
  VALUES (v_reading_uuid, 'es', 'ask simple questions of a factual nature and understand the answers (Alojamiento)', 'Práctica guiada de reading: ask simple questions of a factual nature and understand the answers (Alojamiento).', '{"instruction":"ask simple questions of a factual nature and understand the answers (Alojamiento)","passage":"Reading content pending.","notes":"Contenido pendiente."}'::jsonb);
END;
$seed$;
