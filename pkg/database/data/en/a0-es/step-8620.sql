...
Frage dich: Welche Wortart verstärke ich? **Adjektiv/Adverb** → **so**. **Nomen/Nominalgruppe** → **such**.'::text)
    ...
    VALUES
        (v_ex_id, 'es', 'The ___up is so hot.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'The ___up is so hot.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule1_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'The ___up is so hot.', '{"type": "multiple_choice", "options": ["so", "such", "such a"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'The ___up is so hot.', '{"type": "multiple_choice", "options": ["so", "such", "such a"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'She speaks ___ clearly.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'She speaks ___ clearly.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule1_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'She speaks ___ clearly.', '{"type": "multiple_choice", "options": ["so", "such", "too"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'She speaks ___ clearly.', '{"type": "multiple_choice", "options": ["so", "such", "too"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'It was ___ noisy outside.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'It was ___ noisy outside.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule1_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'It was ___ noisy outside.', '{"type": "multiple_choice", "options": ["so", "such", "such a"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'It was ___ noisy outside.', '{"type": "multiple_choice", "options": ["so", "such", "such a"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'They arrived ___ early.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'They arrived ___ early.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule1_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'They arrived ___ early.', '{"type": "multiple_choice", "options": ["so", "such", "too"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'They arrived ___ early.', '{"type": "multiple_choice", "options": ["so", "such", "too"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'The film was ___ boring.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'The film was ___ boring.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule1_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'The film was ___ boring.', '{"type": "multiple_choice", "options": ["so", "such", "such a"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'The film was ___ boring.', '{"type": "multiple_choice", "options": ["so", "such", "such a"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'He drives ___ carefully.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'He drives ___ carefully.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule1_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'He drives ___ carefully.', '{"type": "multiple_choice", "options": ["so", "such", "too"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'He drives ___ carefully.', '{"type": "multiple_choice", "options": ["so", "such", "too"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'We were ___ tired after the trip.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'We were ___ tired after the trip.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule1_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'We were ___ tired after the trip.', '{"type": "multiple_choice", "options": ["so", "such", "such a"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'We were ___ tired after the trip.', '{"type": "multiple_choice", "options": ["so", "such", "such a"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'It was ___ long meeting.', '{"type": "typing", "correct_answers": ["such a"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'It was ___ long meeting.', '{"type": "typing", "correct_answers": ["such a"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule2_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'It was ___ long meeting.', '{"type": "multiple_choice", "options": ["such a", "so", "such"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'It was ___ long meeting.', '{"type": "multiple_choice", "options": ["such a", "so", "such"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'She is ___ good teacher.', '{"type": "typing", "correct_answers": ["such a"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'She is ___ good teacher.', '{"type": "typing", "correct_answers": ["such a"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule2_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'She is ___ good teacher.', '{"type": "multiple_choice", "options": ["such a", "so", "such"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'She is ___ good teacher.', '{"type": "multiple_choice", "options": ["such a", "so", "such"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'They are ___ friendly neighbours.', '{"type": "typing", "correct_answers": ["such"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'They are ___ friendly neighbours.', '{"type": "typing", "correct_answers": ["such"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule2_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'They are ___ friendly neighbours.', '{"type": "multiple_choice", "options": ["such", "so", "so a"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'They are ___ friendly neighbours.', '{"type": "multiple_choice", "options": ["such", "so", "so a"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'We had ___ bad weather.', '{"type": "typing", "correct_answers": ["such"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'We had ___ bad weather.', '{"type": "typing", "correct_answers": ["such"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule2_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'We had ___ bad weather.', '{"type": "multiple_choice", "options": ["such", "so", "such a"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'We had ___ bad weather.', '{"type": "multiple_choice", "options": ["such", "so", "such a"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'That was ___ interesting idea.', '{"type": "typing", "correct_answers": ["such an"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'That was ___ interesting idea.', '{"type": "typing", "correct_answers": ["such an"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule2_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'That was ___ interesting idea.', '{"type": "multiple_choice", "options": ["such an", "so", "such a"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'That was ___ interesting idea.', '{"type": "multiple_choice", "options": ["such an", "so", "such a"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'He bought ___ expensive shoes.', '{"type": "typing", "correct_answers": ["such"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'He bought ___ expensive shoes.', '{"type": "typing", "correct_answers": ["such"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule2_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'He bought ___ expensive shoes.', '{"type": "multiple_choice", "options": ["such", "so", "such a"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'He bought ___ expensive shoes.', '{"type": "multiple_choice", "options": ["such", "so", "such a"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'This is ___ mess.', '{"type": "typing", "correct_answers": ["such a"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'This is ___ mess.', '{"type": "typing", "correct_answers": ["such a"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule2_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'This is ___ mess.', '{"type": "multiple_choice", "options": ["such a", "so", "such"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'This is ___ mess.', '{"type": "multiple_choice", "options": ["such a", "so", "such"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'He was ___ tired that he fell asleep on the sofa.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'He was ___ tired that he fell asleep on the sofa.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule3_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'He was ___ tired that he fell asleep on the sofa.', '{"type": "multiple_choice", "options": ["so", "such", "very"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'He was ___ tired that he fell asleep on the sofa.', '{"type": "multiple_choice", "options": ["so", "such", "very"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'It was ___ good book that I read it twice.', '{"type": "typing", "correct_answers": ["such a"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'It was ___ good book that I read it twice.', '{"type": "typing", "correct_answers": ["such a"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule3_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'It was ___ good book that I read it twice.', '{"type": "multiple_choice", "options": ["such a", "so", "such"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'It was ___ good book that I read it twice.', '{"type": "multiple_choice", "options": ["such a", "so", "such"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'She spoke ___ quietly that nobody heard her.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'She spoke ___ quietly that nobody heard her.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule3_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'She spoke ___ quietly that nobody heard her.', '{"type": "multiple_choice", "options": ["so", "such", "very"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'She spoke ___ quietly that nobody heard her.', '{"type": "multiple_choice", "options": ["so", "such", "very"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'They had ___ heavy traffic that they missed the train.', '{"type": "typing", "correct_answers": ["such"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'They had ___ heavy traffic that they missed the train.', '{"type": "typing", "correct_answers": ["such"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule3_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'They had ___ heavy traffic that they missed the train.', '{"type": "multiple_choice", "options": ["such", "so", "such a"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'They had ___ heavy traffic that they missed the train.', '{"type": "multiple_choice", "options": ["such", "so", "such a"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'The coffee was ___ strong that I couldn''t sleep.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'The coffee was ___ strong that I couldn''t sleep.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule3_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'The coffee was ___ strong that I couldn''t sleep.', '{"type": "multiple_choice", "options": ["so", "such", "very"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'The coffee was ___ strong that I couldn''t sleep.', '{"type": "multiple_choice", "options": ["so", "such", "very"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'It was ___ easy test that everyone finished early.', '{"type": "typing", "correct_answers": ["such an"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'It was ___ easy test that everyone finished early.', '{"type": "typing", "correct_answers": ["such an"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule3_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'It was ___ easy test that everyone finished early.', '{"type": "multiple_choice", "options": ["such an", "so", "such"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'It was ___ easy test that everyone finished early.', '{"type": "multiple_choice", "options": ["such an", "so", "such"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'We were ___ hungry that we ordered two pizzas.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'We were ___ hungry that we ordered two pizzas.', '{"type": "typing", "correct_answers": ["so"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule3_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'We were ___ hungry that we ordered two pizzas.', '{"type": "multiple_choice", "options": ["so", "such", "very"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'We were ___ hungry that we ordered two pizzas.', '{"type": "multiple_choice", "options": ["so", "such", "very"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', '___, the project is on schedule.', '{"type": "typing", "correct_answers": ["So far"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', '___, the project is on schedule.', '{"type": "typing", "correct_answers": ["So far"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule4_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', '___, the project is on schedule.', '{"type": "multiple_choice", "options": ["So far", "Such far", "As such"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', '___, the project is on schedule.', '{"type": "multiple_choice", "options": ["So far", "Such far", "As such"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'We have visited three cities ___.', '{"type": "typing", "correct_answers": ["so far"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'We have visited three cities ___.', '{"type": "typing", "correct_answers": ["so far"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule4_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'We have visited three cities ___.', '{"type": "multiple_choice", "options": ["so far", "such as", "as such"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'We have visited three cities ___.', '{"type": "multiple_choice", "options": ["so far", "such as", "as such"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'The new job is hard, but ___.', '{"type": "typing", "correct_answers": ["so far so good"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'The new job is hard, but ___.', '{"type": "typing", "correct_answers": ["so far so good"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule4_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'The new job is hard, but ___.', '{"type": "multiple_choice", "options": ["so far so good", "so far good", "such as"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'The new job is hard, but ___.', '{"type": "multiple_choice", "options": ["so far so good", "so far good", "such as"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'I enjoy outdoor sports ___ hiking and cycling.', '{"type": "typing", "correct_answers": ["such as"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'I enjoy outdoor sports ___ hiking and cycling.', '{"type": "typing", "correct_answers": ["such as"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule4_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'I enjoy outdoor sports ___ hiking and cycling.', '{"type": "multiple_choice", "options": ["such as", "so far", "as such"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'I enjoy outdoor sports ___ hiking and cycling.', '{"type": "multiple_choice", "options": ["such as", "so far", "as such"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'He sells fruit ___ apples and pears.', '{"type": "typing", "correct_answers": ["such as"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'He sells fruit ___ apples and pears.', '{"type": "typing", "correct_answers": ["such as"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule4_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'He sells fruit ___ apples and pears.', '{"type": "multiple_choice", "options": ["such as", "so far", "as such"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'He sells fruit ___ apples and pears.', '{"type": "multiple_choice", "options": ["such as", "so far", "as such"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'The report is informal, and ___ it uses simple language.', '{"type": "typing", "correct_answers": ["as such"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'The report is informal, and ___ it uses simple language.', '{"type": "typing", "correct_answers": ["as such"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule4_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'The report is informal, and ___ it uses simple language.', '{"type": "multiple_choice", "options": ["as such", "such as", "so far"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'The report is informal, and ___ it uses simple language.', '{"type": "multiple_choice", "options": ["as such", "such as", "so far"], "answer": 0}'::jsonb);
    ...
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'She is the team leader, and ___ she approves the final plan.', '{"type": "typing", "correct_answers": ["as such"], "case_sensitive": false}'::jsonb),
        (v_ex_id, 'de', 'She is the team leader, and ___ she approves the final plan.', '{"type": "typing", "correct_answers": ["as such"], "case_sensitive": false}'::jsonb);

    INSERT INTO exercise (target_uuid, grammar_rule_uuid) VALUES (v_grammar_id, v_rule4_id) RETURNING uuid INTO v_ex_id;
    INSERT INTO exercise_translation (exercise_uuid, language, prompt, specifics)
    VALUES
        (v_ex_id, 'es', 'She is the team leader, and ___ she approves the final plan.', '{"type": "multiple_choice", "options": ["as such", "such as", "so far"], "answer": 0}'::jsonb),
        (v_ex_id, 'de', 'She is the team leader, and ___ she approves the final plan.', '{"type": "multiple_choice", "options": ["as such", "such as", "so far"], "answer": 0}'::jsonb);
