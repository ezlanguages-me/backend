-- ============================================================
-- Seed: A0 English Path – STEP 2930 – Dialogue – ask to book tickets (Viajes y Transporte)
...
BEGIN
  ...
  VALUES (v_path_uuid, 2930, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'ask to book tickets (Viajes y Transporte)', 'Práctica guiada de diálogo: ask to book tickets (Viajes y Transporte).');
