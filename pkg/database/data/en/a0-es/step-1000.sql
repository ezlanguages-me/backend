-- ============================================================
-- Seed: A0 English Path – STEP 1000 – Dialogue – check that all instructions are understood (Gestión del Estudio y Trámites)
...
BEGIN
  ...
  VALUES (v_path_uuid, 1000, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'check that all instructions are understood (Gestión del Estudio y Trámites)', 'Práctica guiada de diálogo: check that all instructions are understood (Gestión del Estudio y Trámites).');
