-- ============================================================
-- Seed: A0 English Path – STEP 6990 – Dialogue – understand in detail an argument in a discussion programme (Medios de Comunicación)
...
BEGIN
  ...
  VALUES (v_path_uuid, 6990, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'understand in detail an argument in a discussion programme (Medios de Comunicación)', 'Práctica guiada de diálogo: understand in detail an argument in a discussion programme (Medios de Comunicación).');
