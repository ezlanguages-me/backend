-- ============================================================
-- Seed: A0 English Path – STEP 3530 – Dialogue – book a room (face-to-face) in a hotel, bed and breakfast, etc (Alojamiento)
...
BEGIN
  ...
  VALUES (v_path_uuid, 3530, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'book a room (face-to-face) in a hotel, bed and breakfast, etc (Alojamiento)', 'Práctica guiada de diálogo: book a room (face-to-face) in a hotel, bed and breakfast, etc (Alojamiento).');
