-- ============================================================
-- Seed: A0 English Path – STEP 7360 – Dialogue – express opinions on abstract/cultural matters, and defend them (Socialización)
...
BEGIN
  ...
  VALUES (v_path_uuid, 7360, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'express opinions on abstract/cultural matters, and defend them (Socialización)', 'Práctica guiada de diálogo: express opinions on abstract/cultural matters, and defend them (Socialización).');
