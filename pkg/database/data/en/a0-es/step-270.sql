...
BEGIN
  ...
  VALUES (v_path_uuid, 270, 'en')
  RETURNING uuid INTO v_writing_uuid;

  INSERT INTO writing_translation (writing_uuid, language, title, description, prompt)
  VALUES (v_writing_uuid, 'es', 'write simple letters of the ''Thank you'' type (Comunicación Telefónica y Correspondencia Personal)', 'Práctica guiada de writing: write simple letters of the ''Thank you'' type (Comunicación Telefónica y Correspondencia Personal).', '{"instruction":"write simple letters of the ''Thank you'' type (Comunicación Telefónica y Correspondencia Personal)","context":"Contenido pendiente.","language":"es"}'::jsonb);
END;
$seed$;
