...
DECLARE
    ...
    v_exercises JSONB[] := ARRAY[
        '{"p": "The dialogue is about Riverside Castle.", "p_de": "The dialogue is about Riverside Castle.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "The first speaker asks about the visit details.", "p_de": "The first speaker asks about the visit details.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        '{"p": "The second speaker says the ticket costs 8 euros.", "p_de": "The second speaker says the ticket costs 8 euros.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "What time is mentioned?", "p_de": "What time is mentioned?", "s": {"type": "multiple_choice", "options": ["10:00", "05:00", "23:50"], "answer": 0}}'::jsonb,
        '{"p": "Which place is mentioned?", "p_de": "Which place is mentioned?", "s": {"type": "multiple_choice", "options": ["the front gate", "the airport tunnel", "the desert farm"], "answer": 0}}'::jsonb,
        '{"p": "What is the main purpose of the dialogue?", "p_de": "What is the main purpose of the dialogue?", "s": {"type": "multiple_choice", "options": ["the visit details", "buy a tractor", "find a lost camel"], "answer": 0}}'::jsonb,
        '{"p": "How does the dialogue end?", "p_de": "How does the dialogue end?", "s": {"type": "multiple_choice", "options": ["with a clear plan", "with a big argument", "with no clear plan"], "answer": 0}}'::jsonb
    ];
BEGIN
    ...
    VALUES (v_path_id, 6420, 'en', 'dialogue', 'tourism', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Visitor","gender":"neutral","avatarURL":"https://example.com/avatars/visitor.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'Durante la visita a Riverside');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Führung in Riverside Castle');
