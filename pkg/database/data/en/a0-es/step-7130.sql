-- ============================================================
-- Seed: A0 English Path – STEP 7130 – Dialogue – participate in casual conversation over the phone with a known person on a variety of topics (Comunicación Telefónica y Correspondencia Personal)
...
BEGIN
  ...
  VALUES (v_path_uuid, 7130, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'participate in casual conversation over the phone with a known person on a variety of topics (Comunicación Telefónica y Correspondencia Personal)', 'Práctica guiada de diálogo: participate in casual conversation over the phone with a known person on a variety of topics (Comunicación Telefónica y Correspondencia Personal).');
