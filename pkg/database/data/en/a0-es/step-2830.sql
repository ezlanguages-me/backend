-- ============================================================
-- Seed: A0 English Path – STEP 2830 – Dialogue – describe non-visible symptoms such as different kinds of pain (Salud)
...
BEGIN
  ...
  VALUES (v_path_uuid, 2830, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'describe non-visible symptoms such as different kinds of pain (Salud)', 'Práctica guiada de diálogo: describe non-visible symptoms such as different kinds of pain (Salud).');
