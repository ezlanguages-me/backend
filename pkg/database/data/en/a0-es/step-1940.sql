...
BEGIN
  ...
  VALUES (v_path_uuid, 1940, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'go to a self-service or fast food establishment and order a meal (Restauración)', 'Práctica guiada de diálogo: go to a self-service or fast food establishment and order a meal (Restauración).');
