...
-- ============================================================
    ...
    DECLARE
        ...
        v_exercises JSONB[] := ARRAY[
            '{"p": "The audio is about the adviser explains the potential legal risks of terminating the contract early.", "p_de": "The audio is about the adviser explains the potential legal risks of terminating the contract early.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            ...
            '{"p": "One detail is that the penalty clause requires a payment of twenty percent of the total contract value.", "p_de": "One detail is that the penalty clause requires a payment of twenty percent of the total contract value.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            '{"p": "The other side says the client argues that the supplier failed to meet the agreed deadlines.", "p_de": "The other side says the client argues that the supplier failed to meet the agreed deadlines.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            ...
            '{"p": "What is the audio mainly about?", "p_de": "What is the audio mainly about?", "s": {"type": "multiple_choice", "options": ["the adviser explains the potential legal risks of terminating the contract early", "a missing passport", "a mountain rescue"], "answer": 0}}'::jsonb,
            ...
            '{"p": "Who is mentioned?", "p_de": "Who is mentioned?", "s": {"type": "multiple_choice", "options": ["the adviser", "Officer Patel", "Driver Emma"], "answer": 0}}'::jsonb,
            '{"p": "What detail is highlighted?", "p_de": "What detail is highlighted?", "s": {"type": "multiple_choice", "options": ["the penalty clause requires a payment of twenty percent of the total contract value", "the bus breaks down", "the window stays closed"], "answer": 0}}'::jsonb,
            '{"p": "What counterpoint is raised?", "p_de": "What counterpoint is raised?", "s": {"type": "multiple_choice", "options": ["the client argues that the supplier failed to meet the agreed deadlines", "the speaker misses lunch", "the lights turn off"], "answer": 0}}'::jsonb,
            '{"p": "What result do the speakers reach?", "p_de": "What result do the speakers reach?", "s": {"type": "multiple_choice", "options": ["both sides agree to pursue mediation before considering legal action", "they cancel the topic", "they stay completely silent"], "answer": 0}}'::jsonb,
            ...
            '{"p": "Which quote fits best?", "p_de": "Which quote fits best?", "s": {"type": "multiple_choice", "options": ["Careful legal advice prevents costly disputes.", "The weather decides the argument.", "We never need documents."], "answer": 0}}'::jsonb
        ];
    BEGIN
...
[warm] Listener: As the speaker says, "Careful legal advice prevents costly disputes."$transcript$
        ...
        INSERT INTO listening_translation (listening_uuid, language, title) VALUES (v_listening_id, 'es', 'Audio de asuntos delicados');
        INSERT INTO listening_translation (listening_uuid, language, title) VALUES (v_listening_id, 'de', 'Audio zu heiklen Themen');
