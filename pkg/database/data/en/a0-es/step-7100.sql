...
BEGIN
    ...
    VALUES (v_path_id, 7100, 'en', 'speaking', 'phone_correspondence')RETURNING uuid INTO v_speaking_id;
    INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
    VALUES (v_speaking_id, 'es', 'Confirmar planes por teléfono', '{"scenario": "Estás al teléfono hablando sobre Seville.", "tasks": ["Saluda a la otra persona.", "Di el destino o plan principal.", "Menciona el día.", "Menciona la hora.", "Di el medio de transporte.", "Di el lugar de encuentro.", "Haz una petición simple.", "Confirma el plan al final."]}'::jsonb);
    INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
    VALUES (v_speaking_id, 'de', 'Pläne am Telefon bestätigen', '{"scenario": "Du telefonierst über Seville.", "tasks": ["Begrüße die andere Person.", "Nenne das Ziel oder den Hauptplan.", "Nenne den Tag.", "Nenne die Uhrzeit.", "Nenne das Verkehrsmittel.", "Nenne den Treffpunkt.", "Stelle eine einfache Bitte.", "Bestätige den Plan am Ende."]}'::jsonb);
END; $seed$;
