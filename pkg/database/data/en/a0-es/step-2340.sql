...
BEGIN
  ...
  VALUES (v_path_uuid, 2340, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'maintain an interaction related to the nature and quality of the food (Restauración)', 'Práctica guiada de diálogo: maintain an interaction related to the nature and quality of the food (Restauración).');
