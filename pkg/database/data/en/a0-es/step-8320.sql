...
DELETE FROM writing WHERE step_order=8320 AND path_uuid=v_path_id;
        ...
        VALUES (v_path_id,8320,'en','listening','academic',$transcript$# AUDIO PROFILE
...
[warm] Guest: As the speaker says, "Evidence matters more than volume in an opinion."$transcript$)
        ...
        INSERT INTO listening_translation (listening_uuid,language,title,description) VALUES (v_listening_id,'es','listen to opinion-based discussion','Escucha el audio y responde.');
        INSERT INTO listening_translation (listening_uuid,language,title,description) VALUES (v_listening_id,'de','listen to opinion-based discussion','Höre das Audio und beantworte die Fragen.');
