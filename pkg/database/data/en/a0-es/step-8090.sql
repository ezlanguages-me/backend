-- ============================================================
-- Seed: A0 English Path – STEP 8090 – Dialogue – give coherent explanations of a theoretical nature (Conferencias, Seminarios y Clases)
...
BEGIN
  ...
  VALUES (v_path_uuid, 8090, 'en', 'practice', '[{"name":"Guide","gender":"neutral","avatarURL":"https://example.com/avatars/guide.png"},{"name":"Learner","gender":"neutral","avatarURL":"https://example.com/avatars/learner.png"}]'::jsonb)
  RETURNING uuid INTO v_dialogue_uuid;

  INSERT INTO dialogue_translation (dialogue_uuid, language, title, description)
  VALUES (v_dialogue_uuid, 'es', 'give coherent explanations of a theoretical nature (Conferencias, Seminarios y Clases)', 'Práctica guiada de diálogo: give coherent explanations of a theoretical nature (Conferencias, Seminarios y Clases).');
