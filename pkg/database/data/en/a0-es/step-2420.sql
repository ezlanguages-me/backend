...
BEGIN
    ...
    VALUES (v_path_id, 2420, 'en', 'dialogue', 'dining', '[{"name": "Guest", "gender": "female", "avatarURL": "https://example.com/avatars/guest.png"}, {"name": "Manager", "gender": "male", "avatarURL": "https://example.com/avatars/manager.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'Reclamación completa y llegar');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Vollständige Beschwerde');
