-- ============================================================
-- Seed: English Path – STEP 50 – Deck – VERBS
-- Source language: Spanish (es translations included); German fields removed
-- Generated from pasted verb list
-- ============================================================
DO $seed$
DECLARE
  v_path_id UUID;
  ...
  v_verbs JSONB[] := ARRAY[
        ...
        '{"v":"bring","p":"brought","pp":"brought","es":"traer","ex":"Can you bring me a glass of water, please?","pron_v":"/bring/","pron_p":"/brot/","pron_pp":"/brot/"}'::jsonb,
        ...
        '{"v":"cling","p":"clung","pp":"clung","es":"aferrarse / pegarse","ex":"The wet shirt clung to his skin.","pron_v":"/kling/","pron_p":"/klang/","pron_pp":"/klang/"}'::jsonb,
        ...
        '{"v":"hang","p":"hung","pp":"hung","es":"colgar","ex":"She hung her coat on the hook by the door.","pron_v":"/hang/","pron_p":"/hang/","pron_pp":"/hang/"}'::jsonb,
        ...
        '{"v":"ring","p":"rang","pp":"rung","es":"sonar / llamar (por telefono)","ex":"The phone rang three times before she answered.","pron_v":"/ring/","pron_p":"/rang/","pron_pp":"/rang/"}'::jsonb,
        ...
        '{"v":"sing","p":"sang","pp":"sung","es":"cantar","ex":"She sang a beautiful song at the concert.","pron_v":"/sing/","pron_p":"/sang/","pron_pp":"/sang/"}'::jsonb,
        ...
        '{"v":"spring","p":"sprang","pp":"sprung","es":"saltar / brotar / surgir de repente","ex":"He sprang out of bed when he heard the alarm.","pron_v":"/spring/","pron_p":"/sprang/","pron_pp":"/sprang/"}'::jsonb,
        ...
        '{"v":"sting","p":"stung","pp":"stung","es":"picar / escocer","ex":"A bee stung me on the arm at the park.","pron_v":"/sting/","pron_p":"/stang/","pron_pp":"/stang/"}'::jsonb,
        ...
        '{"v":"swing","p":"swung","pp":"swung","es":"balancearse / mecer","ex":"The children were swinging in the park.","pron_v":"/suíng/","pron_p":"/suang/","pron_pp":"/suang/"}'::jsonb,
        ...
        '{"v":"wring","p":"wrung","pp":"wrung","es":"retorcer / escurrir","ex":"She wrung out the wet towel after washing it.","pron_v":"/ring/","pron_p":"/rang/","pron_pp":"/rang/"}'::jsonb,
        ...
        '{"v":"add","p":"added","pp":"added","es":"añadir / agregar","ex":"Add some salt to improve the flavor.","pron_v":"/ad/","pron_p":"/á-did/","pron_pp":"/á-did/"}'::jsonb,
        '{"v":"allow","p":"allowed","pp":"allowed","es":"permitir / dejar","ex":"The teacher allows us to use dictionaries in exams.","pron_v":"/a-láu/","pron_p":"/a-láud/","pron_pp":"/a-láud/"}'::jsonb,
        '{"v":"avoid","p":"avoided","pp":"avoided","es":"evitar","ex":"Try to avoid eating too much sugar.","pron_v":"/a-vóid/","pron_p":"/a-vói-did/","pron_pp":"/a-vói-did/"}'::jsonb,
        '{"v":"communicate","p":"communicated","pp":"communicated","es":"comunicarse","ex":"She communicates well with her team.","pron_v":"/ko-miú-ni-keit/","pron_p":"/ko-miú-ni-kei-tid/","pron_pp":"/ko-miú-ni-kei-tid/"}'::jsonb,
        '{"v":"connect","p":"connected","pp":"connected","es":"conectar","ex":"Connect the cable to the back of the computer.","pron_v":"/ko-nékt/","pron_p":"/ko-nék-tid/","pron_pp":"/ko-nék-tid/"}'::jsonb,
        '{"v":"cook","p":"cooked","pp":"cooked","es":"cocinar","ex":"She cooked a delicious pasta for dinner.","pron_v":"/kuk/","pron_p":"/kukt/","pron_pp":"/kukt/"}'::jsonb,
        '{"v":"cover","p":"covered","pp":"covered","es":"cubrir / tapar","ex":"Cover the pot and let it simmer for 20 minutes.","pron_v":"/ká-ver/","pron_p":"/ká-verd/","pron_pp":"/ká-verd/"}'::jsonb,
        '{"v":"develop","p":"developed","pp":"developed","es":"desarrollar","ex":"The team developed a new app in three months.","pron_v":"/di-vé-lop/","pron_p":"/di-vé-lopt/","pron_pp":"/di-vé-lopt/"}'::jsonb,
        '{"v":"earn","p":"earned","pp":"earned","es":"ganar (dinero / sueldo)","ex":"She earns a good salary as a software engineer.","pron_v":"/ern/","pron_p":"/ernd/","pron_pp":"/ernd/"}'::jsonb,
        '{"v":"enter","p":"entered","pp":"entered","es":"entrar","ex":"Please enter your password to unlock the device.","pron_v":"/én-ter/","pron_p":"/én-terd/","pron_pp":"/én-terd/"}'::jsonb,
        '{"v":"explain","p":"explained","pp":"explained","es":"explicar","ex":"Can you explain how this machine works?","pron_v":"/eks-pléin/","pron_p":"/eks-pléind/","pron_pp":"/eks-pléind/"}'::jsonb,
        '{"v":"finish","p":"finished","pp":"finished","es":"terminar / acabar","ex":"I need to finish this report by Friday.","pron_v":"/fí-nish/","pron_p":"/fí-nisht/","pron_pp":"/fí-nisht/"}'::jsonb,
        '{"v":"guess","p":"guessed","pp":"guessed","es":"adivinar","ex":"Can you guess what I''m thinking?","pron_v":"/ges/","pron_p":"/gest/","pron_pp":"/gest/"}'::jsonb,
        '{"v":"open","p":"opened","pp":"opened","es":"abrir","ex":"Could you open the window? It''s hot in here.","pron_v":"/óu-pen/","pron_p":"/óu-pend/","pron_pp":"/óu-pend/"}'::jsonb,
        '{"v":"point","p":"pointed","pp":"pointed","es":"señalar / apuntar","ex":"She pointed to the map to show where she lives.","pron_v":"/point/","pron_p":"/póin-tid/","pron_pp":"/póin-tid/"}'::jsonb,
        '{"v":"prepare","p":"prepared","pp":"prepared","es":"preparar","ex":"He prepared a presentation for the meeting.","pron_v":"/pri-pér/","pron_p":"/pri-pérd/","pron_pp":"/pri-pérd/"}'::jsonb,
        '{"v":"produce","p":"produced","pp":"produced","es":"producir / fabricar","ex":"This factory produces over 500 cars a day.","pron_v":"/pro-diús/","pron_p":"/pro-diúst/","pron_pp":"/pro-diúst/"}'::jsonb,
        '{"v":"promise","p":"promised","pp":"promised","es":"prometer","ex":"I promise I''ll call you as soon as I arrive.","pron_v":"/pró-mis/","pron_p":"/pró-mist/","pron_pp":"/pró-mist/"}'::jsonb,
        '{"v":"raise","p":"raised","pp":"raised","es":"levantar / subir / criar","ex":"She raised her hand to ask a question.","pron_v":"/reis/","pron_p":"/reist/","pron_pp":"/reist/"}'::jsonb,
        '{"v":"reduce","p":"reduced","pp":"reduced","es":"reducir / disminuir","ex":"We need to reduce our energy consumption.","pron_v":"/ri-diús/","pron_p":"/ri-diúst/","pron_pp":"/ri-diúst/"}'::jsonb,
        '{"v":"release","p":"released","pp":"released","es":"liberar / lanzar / soltar","ex":"The band released their new album last Friday.","pron_v":"/ri-lís/","pron_p":"/ri-líst/","pron_pp":"/ri-líst/"}'::jsonb,
        '{"v":"seem","p":"seemed","pp":"seemed","es":"parecer","ex":"You seem tired today. Did you sleep well?","pron_v":"/sim/","pron_p":"/simd/","pron_pp":"/simd/"}'::jsonb,
        '{"v":"fling","p":"flung","pp":"flung","es":"lanzar / arrojar con fuerza","ex":"She flung her keys on the table and collapsed on the sofa.","pron_v":"/fling/","pron_p":"/flang/","pron_pp":"/flang/"}'::jsonb,
        '{"v":"lie","p":"lay","pp":"lain","es":"estar tumbado / yacer","ex":"She lay on the bed and stared at the ceiling.","pron_v":"/lái/","pron_p":"/lei/","pron_pp":"/lein/"}'::jsonb,
        '{"v":"strike","p":"struck","pp":"struck","es":"golpear / atacar / hacer huelga","ex":"Lightning struck the tree in the garden.","pron_v":"/straik/","pron_p":"/strak/","pron_pp":"/strak/"}'::jsonb,
        '{"v":"withdraw","p":"withdrew","pp":"withdrawn","es":"retirar / sacar / retirarse","ex":"She withdrew money from the ATM before catching the train.","pron_v":"/uid-dró/","pron_p":"/uid-dru/","pron_pp":"/uid-drón/"}'::jsonb  ];
BEGIN

  -- 1. Obtener el path
  SELECT uuid INTO v_path_id FROM path WHERE source_language = 'en' LIMIT 1;

  -- Evitar duplicados en testing
  DELETE FROM deck WHERE step_order = 50 AND path_uuid = v_path_id;
  ...
  -- 3. Traducción del deck al español
  INSERT INTO deck_translation (deck_uuid, language, title)
  VALUES (v_deck_id, 'es', 'Los Verbos');

  -- 4. Bucle para insertar verbos e inflexiones
  FOREACH v_item IN ARRAY v_verbs
  LOOP
    -- A) Verbo raíz (infinitive)
    SELECT get_or_create_word(v_item->>'v', 'en', v_item->>'ex') INTO v_root_id;

    -- Obtener/crear la palabra de traducción en español
    SELECT get_or_create_word(v_item->>'es', 'es') INTO v_es_id;

    -- A.1) Traducción y pronunciación (es)
    INSERT INTO word_translation (source_word_uuid, target_word_uuid, pronunciation)
    VALUES (v_root_id, v_es_id, COALESCE(v_item->>'pron_v',''))
    ON CONFLICT DO NOTHING;

    -- A.2) Vincular al deck
    ...
    -- B.1) Traducción y pronunciación (es) para pasado
    INSERT INTO word_translation (source_word_uuid, target_word_uuid, pronunciation)
    VALUES (v_past_id, v_es_id, COALESCE(v_item->>'pron_p',''))
    ON CONFLICT DO NOTHING;
    ...
    -- C.1) Traducción y pronunciación (es) para participio pasado
    INSERT INTO word_translation (source_word_uuid, target_word_uuid, pronunciation)
    VALUES (v_pp_id, v_es_id, COALESCE(v_item->>'pron_pp',''))
    ON CONFLICT DO NOTHING;
