...
BEGIN
    ...
    VALUES (v_path_id, 7150, 'en', 'reading', 'phone_correspondence', 'Dear Eva,\n\nI am happy to write about the trip to Toledo. The date is next Thursday and the time is 09:15.\n\nWe can travel by bus and meet at the station cafe. Please confirm the tickets tonight.\n\nPlease confirm,\nMarco')RETURNING uuid INTO v_reading_id;
    INSERT INTO reading_translation (reading_uuid, language, title) VALUES (v_reading_id, 'es', 'Carta sobre planes de viaje');
    INSERT INTO reading_translation (reading_uuid, language, title) VALUES (v_reading_id, 'de', 'Brief über Reisepläne');
