...
-- ============================================================
    ...
    DECLARE
        ...
        v_exercises JSONB[] := ARRAY[
            '{"p": "The dialogue is about the adviser explains the potential legal risks of terminating the contract early.", "p_de": "The dialogue is about the adviser explains the potential legal risks of terminating the contract early.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            ...
            '{"p": "Adviser explains that the penalty clause requires a payment of twenty percent of the total contract value.", "p_de": "Adviser explains that the penalty clause requires a payment of twenty percent of the total contract value.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            '{"p": "A counterpoint is that the client argues that the supplier failed to meet the agreed deadlines.", "p_de": "A counterpoint is that the client argues that the supplier failed to meet the agreed deadlines.", "s": {"type": "true_false", "answer": true}}'::jsonb,
            ...
            '{"p": "What is the main focus?", "p_de": "What is the main focus?", "s": {"type": "multiple_choice", "options": ["the adviser explains the potential legal risks of terminating the contract early", "a broken bus stop", "a lost suitcase"], "answer": 0}}'::jsonb,
            '{"p": "Who gives the main explanation?", "p_de": "Who gives the main explanation?", "s": {"type": "multiple_choice", "options": ["Adviser", "the cleaner", "the taxi driver"], "answer": 0}}'::jsonb,
            '{"p": "Which detail is named?", "p_de": "Which detail is named?", "s": {"type": "multiple_choice", "options": ["the penalty clause requires a payment of twenty percent of the total contract value", "the door is painted blue", "the train leaves at midnight"], "answer": 0}}'::jsonb,
            '{"p": "Which counterpoint appears?", "p_de": "Which counterpoint appears?", "s": {"type": "multiple_choice", "options": ["the client argues that the supplier failed to meet the agreed deadlines", "nobody has a notebook", "the lesson is cancelled"], "answer": 0}}'::jsonb,
            '{"p": "What conclusion do the speakers reach?", "p_de": "What conclusion do the speakers reach?", "s": {"type": "multiple_choice", "options": ["both sides agree to pursue mediation before considering legal action", "they forget the topic completely", "they decide to leave the room"], "answer": 0}}'::jsonb
        ];
    BEGIN
...
DELETE FROM writing WHERE step_order=9110 AND path_uuid=v_path_id;
        ...
        VALUES (v_path_id, 9110, 'en', 'dialogue', 'professional', '[{"name": "Client", "gender": "neutral", "avatarURL": "https://example.com/avatars/customer.png"}, {"name": "Adviser", "gender": "neutral", "avatarURL": "https://example.com/avatars/clerk.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
        INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'Diálogo delicado');
        INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Heikler Dialog');
