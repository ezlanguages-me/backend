...
BEGIN
  ...
  VALUES (v_path_uuid, 6180, 'en', 'speaking', 'accommodation')RETURNING uuid INTO v_speaking_uuid;
  INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
  VALUES (v_speaking_uuid, 'es', 'Casa a tu compañero de piso', '{"scenario": "Tu nuevo compañero de piso llega hoy y tú le explicas las normas básicas de la casa.", "tasks": ["Explica la hora de silencio por la noche.", "Di cómo se usan las zonas comunes.", "Menciona qué pasa con los invitados.", "Explica dónde se deja la basura.", "Di qué hacer con los zapatos o la ropa mojada.", "Menciona la lavandería o la cocina compartida.", "Di cómo se paga la renta o los gastos compartidos.", "Termina diciendo que puede preguntarte dudas cuando quiera."]}'::jsonb), (v_speaking_uuid, 'de', 'Erkläre deinem Mitbewohner', '{"scenario": "Dein neuer Mitbewohner kommt heute an und du erklärst die grundlegenden Hausregeln.", "tasks": ["Erkläre die Nachtruhe.", "Sag, wie die Gemeinschaftsbereiche benutzt werden.", "Erwähne, was mit Gästen gilt.", "Erkläre, wo der Müll hingehört.", "Sag, was mit Schuhen oder nasser Kleidung passiert.", "Erwähne die Waschküche oder die gemeinsame Küche.", "Sag, wie Miete oder gemeinsame Kosten bezahlt werden.", "Schließe damit ab, dass er dich jederzeit fragen kann."]}'::jsonb);
END;
$seed$;
