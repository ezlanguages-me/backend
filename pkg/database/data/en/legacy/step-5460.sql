...
BEGIN
    ...
    VALUES (v_path_id, 5460, 'en', 'dialogue', 'academic', '[{"name": "Nora", "gender": "female", "avatarURL": "https://example.com/avatars/nora.png"}, {"name": "Iker", "gender": "male", "avatarURL": "https://example.com/avatars/iker.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES (v_dialogue_id, 'es', 'Tomar turnos en una discusión');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES (v_dialogue_id, 'de', 'Sich in einer Diskussion');
