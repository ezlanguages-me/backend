...
BEGIN
    ...
    VALUES (v_path_id, 5260, 'en', 'dialogue', 'academic', '[{"name": "Audience member", "gender": "female", "avatarURL": "https://example.com/avatars/audience-member.png"}, {"name": "Presenter", "gender": "male", "avatarURL": "https://example.com/avatars/presenter.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES (v_dialogue_id, 'es', 'Participar en preguntas tras');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES (v_dialogue_id, 'de', 'Fragerunde nach einem Vortrag');
