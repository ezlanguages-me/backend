...
BEGIN
    ...
    VALUES (v_path_id, 6260, 'en', 'dialogue', 'social', '[{"name": "Marta","gender": "female","avatarURL": "https://example.com/avatars/student-3.png"},{"name": "Jon","gender": "male","avatarURL": "https://example.com/avatars/student-4.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES
        (v_dialogue_id, 'es', 'Planes y actividades sociales'), (v_dialogue_id, 'de', 'Soziale Pläne und Aktivitäten');
