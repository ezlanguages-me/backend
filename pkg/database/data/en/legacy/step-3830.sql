...
BEGIN
    ...
    VALUES (v_path_id, 3830, 'en', 'dialogue', 'professional', '[{"name": "Client", "gender": "female", "avatarURL": "https://example.com/avatars/client.png"}, {"name": "Coordinator", "gender": "male", "avatarURL": "https://example.com/avatars/coordinator.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES
        (v_dialogue_id, 'es', 'Habla sobre requisitos'), (v_dialogue_id, 'de', 'Arbeitsanforderungen');
