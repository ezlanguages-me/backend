...
DECLARE
    ...
    v_exercises JSONB[] := ARRAY[
        '{"p": "The dialogue is about the bridge report.", "p_de": "The dialogue is about the bridge report.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "The first speaker asks about the news story.", "p_de": "The first speaker asks about the news story.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        '{"p": "The second speaker says the bridge connects two parks.", "p_de": "The second speaker says the bridge connects two parks.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "Who gives the main information?", "p_de": "Who gives the main information?", "s": {"type": "multiple_choice", "options": ["Sam", "a pilot", "a football player"], "answer": 0}}'::jsonb,
        '{"p": "What time is mentioned?", "p_de": "What time is mentioned?", "s": {"type": "multiple_choice", "options": ["18:00", "05:00", "23:50"], "answer": 0}}'::jsonb,
        '{"p": "Which place is mentioned?", "p_de": "Which place is mentioned?", "s": {"type": "multiple_choice", "options": ["the TV report", "the airport tunnel", "the desert farm"], "answer": 0}}'::jsonb,
        '{"p": "What is the main purpose of the dialogue?", "p_de": "What is the main purpose of the dialogue?", "s": {"type": "multiple_choice", "options": ["the news story", "buy a tractor", "find a lost camel"], "answer": 0}}'::jsonb,
        '{"p": "How does the dialogue end?", "p_de": "How does the dialogue end?", "s": {"type": "multiple_choice", "options": ["with agreement about the main idea", "with a big argument", "with no clear plan"], "answer": 0}}'::jsonb
    ];
BEGIN
    ...
    VALUES (v_path_id, 6910, 'en', 'dialogue', 'media', '[{"name":"Mia","gender":"female","avatarURL":"https://example.com/avatars/mia.png"},{"name":"Sam","gender":"male","avatarURL":"https://example.com/avatars/sam.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'La noticia del puente');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Brückennachricht sprechen');
