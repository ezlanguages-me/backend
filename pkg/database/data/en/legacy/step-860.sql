...
DECLARE
  ...
  v_exercises JSONB[] := ARRAY[
        ...
        '{"es": "Los estudiantes llegan a las 9:15 AM.", "de": "Die Lernenden kommen um 9:15 Uhr an.", "s_es": {"type": "true_false", "answer": false}, "s_de": {"type": "true_false", "answer": false}}'::jsonb,
        ...
        '{"es": "¿Qué hacen después de escribir el nombre?", "de": "Was machen sie nach dem Schreiben des Namens?", "s_es": {"type": "multiple_choice", "options": ["Salir del aula", "Leer las páginas 6 y 7", "Llamar al profesor"], "answer": 1}, "s_de": {"type": "multiple_choice", "options": ["Den Raum verlassen", "Die Seiten 6 und 7 lesen", "Die Lehrkraft anrufen"], "answer": 1}}'::jsonb,
        '{"es": "¿Qué preguntas contestan?", "de": "Welche Fragen beantworten sie?", "s_es": {"type": "multiple_choice", "options": ["Las preguntas 5 a 8", "Las preguntas 1 a 4", "Solo la pregunta 10"], "answer": 1}, "s_de": {"type": "multiple_choice", "options": ["Die Fragen 5 bis 8", "Die Fragen 1 bis 4", "Nur Frage 10"], "answer": 1}}'::jsonb,
        '{"es": "¿Cómo trabajan al principio?", "de": "Wie arbeiten sie am Anfang?", "s_es": {"type": "multiple_choice", "options": ["En grupos grandes", "Solos durante diez minutos", "Con el director"], "answer": 1}, "s_de": {"type": "multiple_choice", "options": ["In großen Gruppen", "Allein für zehn Minuten", "Mit dem Direktor"], "answer": 1}}'::jsonb,
        '{"es": "¿Antes de qué hora envían la foto?", "de": "Vor welcher Uhrzeit senden sie das Foto?", "s_es": {"type": "multiple_choice", "options": ["Antes de las 9 PM del martes", "Antes del mediodía", "Antes de las 6 PM del miércoles"], "answer": 2}, "s_de": {"type": "multiple_choice", "options": ["Vor 21 Uhr am Dienstag", "Vor Mittag", "Vor 18 Uhr am Mittwoch"], "answer": 2}}'::jsonb,
        '{"es": "¿Dónde es la prueba corta del viernes?", "de": "Wo ist der kurze Test am Freitag?", "s_es": {"type": "multiple_choice", "options": ["En el aula 204", "En la biblioteca", "En el aula 105"], "answer": 2}, "s_de": {"type": "multiple_choice", "options": ["In Raum 204", "In der Bibliothek", "In Raum 105"], "answer": 2}}'::jsonb
    ];
BEGIN
...
For homework, finish Exercise 5 and send one photo before Wednesday at 6 PM. Next Friday, we meet in Room 105 for the short test. If you cannot come, email your teacher.'
  ...
  VALUES
    (v_reading_uuid, 'es', 'Horario de clase y tarea'), (v_reading_uuid, 'de', 'Unterrichtsplan und Aufgaben');
