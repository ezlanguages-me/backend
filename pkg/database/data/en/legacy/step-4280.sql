...
BEGIN
    ...
    VALUES (v_path_id, 4280, 'en', 'dialogue', 'professional', '[{"name": "Engineer", "gender": "male", "avatarURL": "https://example.com/avatars/engineer.png"}, {"name": "Manager", "gender": "female", "avatarURL": "https://example.com/avatars/manager.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES
        (v_dialogue_id, 'es', 'Aclara los requisitos técnicos'), (v_dialogue_id, 'de', 'Kläre technische Anforderungen');
