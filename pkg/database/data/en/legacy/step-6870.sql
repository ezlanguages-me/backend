...
DECLARE
    ...
    v_exercises JSONB[] := ARRAY[
        '{"p": "The dialogue is about a picnic plan.", "p_de": "The dialogue is about a picnic plan.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "The first speaker asks about the invitation plan.", "p_de": "The first speaker asks about the invitation plan.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        '{"p": "The second speaker says they meet in Central Park.", "p_de": "The second speaker says they meet in Central Park.", "s": {"type": "true_false", "answer": true}}'::jsonb,
        ...
        '{"p": "What time is mentioned?", "p_de": "What time is mentioned?", "s": {"type": "multiple_choice", "options": ["13:00", "05:00", "23:50"], "answer": 0}}'::jsonb,
        '{"p": "Which place is mentioned?", "p_de": "Which place is mentioned?", "s": {"type": "multiple_choice", "options": ["Central Park", "the airport tunnel", "the desert farm"], "answer": 0}}'::jsonb,
        '{"p": "What is the main purpose of the dialogue?", "p_de": "What is the main purpose of the dialogue?", "s": {"type": "multiple_choice", "options": ["the invitation plan", "buy a tractor", "find a lost camel"], "answer": 0}}'::jsonb,
        '{"p": "How does the dialogue end?", "p_de": "How does the dialogue end?", "s": {"type": "multiple_choice", "options": ["with the plan accepted", "with a big argument", "with no clear plan"], "answer": 0}}'::jsonb
    ];
BEGIN
    ...
    VALUES (v_path_id, 6870, 'en', 'dialogue', 'socializing', '[{"name":"Ana","gender":"female","avatarURL":"https://example.com/avatars/ana.png"},{"name":"Leo","gender":"male","avatarURL":"https://example.com/avatars/leo.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'Hacer planes con un amigo');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Mit einem Freund Pläne machen');
