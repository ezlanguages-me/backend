...
BEGIN
  ...
  VALUES (v_path_uuid, 6070, 'en', 'speaking', 'accommodation')RETURNING uuid INTO v_speaking_uuid;
  INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
  VALUES (v_speaking_uuid, 'es', 'Detalles del contrato', '{"scenario": "Tienes delante un contrato de alquiler y quieres aclarar las condiciones antes de firmar.", "tasks": ["Pregunta por la duración total del contrato.", "Di si la fianza te parece alta o razonable.", "Pregunta qué gastos están incluidos.", "Pregunta si hay una cláusula de aviso.", "Menciona si necesitas permiso para subarrendar.", "Pregunta qué pasa si sales antes de tiempo.", "Di qué punto del contrato quieres revisar otra vez.", "Termina confirmando que entiendes las condiciones principales."]}'::jsonb), (v_speaking_uuid, 'de', 'Die Details des Mietvertrags', '{"scenario": "Du hast einen Mietvertrag vor dir und möchtest die Bedingungen vor der Unterschrift klären.", "tasks": ["Frage nach der gesamten Vertragsdauer.", "Sag, ob dir die Kaution hoch oder angemessen erscheint.", "Frage, welche Nebenkosten enthalten sind.", "Frage, ob es eine Kündigungsklausel gibt.", "Erwähne, ob du eine Erlaubnis zum Untervermieten brauchst.", "Frage, was passiert, wenn du früher ausziehst.", "Sag, welchen Punkt du noch einmal prüfen möchtest.", "Schließe ab, indem du bestätigst, dass du die wichtigsten Bedingungen verstanden hast."]}'::jsonb);
END;
$seed$;
