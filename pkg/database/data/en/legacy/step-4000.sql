...
BEGIN
    ...
    VALUES
        (v_item_id, 'es', 'Solicitudes rutinarias', '{"scenario": "En tu trabajo necesitas hacer una solicitud rutinaria a un proveedor. Quieres escribir un mensaje claro con producto, cantidad, fecha y datos de contacto.", "tasks": ["Escribe el saludo y el nombre de la empresa o persona.", "Indica qué producto o servicio necesitas.", "Di la cantidad o frecuencia exacta.", "Añade un detalle importante como tamaño, modelo o referencia.", "Indica la fecha o franja en la que lo necesitas.", "Escribe el lugar de entrega o el punto de servicio.", "Pide confirmación de disponibilidad, precio o plazo.", "Termina con un agradecimiento y tus datos de contacto."]}'::jsonb), (v_item_id, 'de', 'Waren oder Dienstleistungen', '{"scenario": "Bei deiner Arbeit musst du eine routinemäßige Anfrage an einen Lieferanten schicken. Du möchtest eine klare Nachricht mit Produkt, Menge, Termin und Kontaktdaten schreiben.", "tasks": ["Schreibe die Begrüßung und den Namen der Firma oder Person.", "Nenne die Ware oder Dienstleistung, die du brauchst.", "Nenne die genaue Menge oder Häufigkeit.", "Füge ein wichtiges Detail wie Größe, Modell oder Referenz hinzu.", "Nenne das gewünschte Datum oder Lieferfenster.", "Schreibe den Lieferort oder Einsatzort.", "Bitte um Bestätigung von Verfügbarkeit, Preis oder Termin.", "Beende die Nachricht mit einem Dank und deinen Kontaktdaten."]}'::jsonb);
END;
$seed$;
