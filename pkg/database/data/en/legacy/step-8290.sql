...
[warm] Guest: As the speaker says, "Evidence matters more than volume in an opinion."$transcript$
        ...
        INSERT INTO listening_translation (listening_uuid, language, title) VALUES (v_listening_id, 'es', 'Debate académico evaluativo');
        INSERT INTO listening_translation (listening_uuid, language, title) VALUES (v_listening_id, 'de', 'Bewertende Fachdiskussion');
