...
BEGIN
    ...
    VALUES (v_path_id, 2180, 'en', 'dialogue', 'dining', '[{"name": "Nico", "gender": "male", "avatarURL": "https://example.com/avatars/nico.png"}, {"name": "Waiter", "gender": "female", "avatarURL": "https://example.com/avatars/waiter-f.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'es', 'Preguntar por platos');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title) VALUES (v_dialogue_id, 'de', 'Gerichten und Service fragen');
