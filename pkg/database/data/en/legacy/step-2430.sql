...
BEGIN
    ...
    VALUES (v_path_id, 2430, 'en', 'speaking', 'dining')RETURNING uuid INTO v_speaking_id;

    INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
    VALUES (v_speaking_id, 'es', 'Presentar una queja compleja', '{"scenario": "Has tenido varios problemas en un restaurante: mucha espera, plato equivocado, posible riesgo de alergia y errores en la cuenta. Expón la situación y pide una solución completa.", "tasks": ["Llama al encargado o al gerente.", "Explica cuánto tiempo has esperado.", "Describe el error principal del pedido.", "Menciona el problema relacionado con una alergia o ingrediente peligroso.", "Explica el error de la cuenta.", "Pide una solución concreta para cada problema.", "Di qué compensación te parece justa.", "Termina de forma educada pero firme."]}'::jsonb);
    INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
    VALUES (v_speaking_id, 'de', 'Beschwerde im Restaurant', '{"scenario": "Du hattest mehrere Probleme in einem Restaurant: lange Wartezeit, falsches Gericht, mögliches Allergierisiko und Fehler auf der Rechnung. Erkläre die Situation und bitte um eine vollständige Lösung.", "tasks": ["Rufe den Manager oder die Managerin.", "Erkläre, wie lange du gewartet hast.", "Beschreibe den Hauptfehler bei der Bestellung.", "Erwähne das Problem mit einer Allergie oder einer gefährlichen Zutat.", "Erkläre den Fehler auf der Rechnung.", "Bitte um eine konkrete Lösung für jedes Problem.", "Sage, welche Entschädigung du fair findest.", "Beende höflich, aber bestimmt."]}'::jsonb);
END;
$seed$;
