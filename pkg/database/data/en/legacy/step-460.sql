...
DECLARE
    ...
    v_exercises JSONB[] := ARRAY[
        ...
        -- MULTIPLE CHOICE (10 exercises, distribution {0:3, 1:4, 2:3})
        ...
        '{"p": "¿Qué gastos están incluidos?", "p_de": "Welche Kosten sind inklusive?", "s": {"type": "multiple_choice", "options": ["Solo agua", "Agua, electricidad y Wi‑Fi", "Solo Wi‑Fi"], "answer": 1}}'::jsonb,
        ...
        '{"p": "¿En qué planta está el piso?", "p_de": "In welchem Stock liegt die Wohnung?", "s": {"type": "multiple_choice", "options": ["En la primera", "En la planta baja", "En la tercera"], "answer": 2}}'::jsonb,
        '{"p": "¿Qué transporte está cerca?", "p_de": "Welches Verkehrsmittel ist in der Nähe?", "s": {"type": "multiple_choice", "options": ["La estación de tren", "La parada de autobús", "El aeropuerto"], "answer": 1}}'::jsonb,
        '{"p": "¿Qué no está permitido?", "p_de": "Was ist nicht erlaubt?", "s": {"type": "multiple_choice", "options": ["Cocinar", "Usar Wi‑Fi", "Fumar"], "answer": 2}}'::jsonb,
        '{"p": "¿Qué animales permite el anuncio?", "p_de": "Welche Tiere erlaubt die Anzeige?", "s": {"type": "multiple_choice", "options": ["Solo gatos", "Ninguno", "Solo perros pequeños"], "answer": 1}}'::jsonb,
        ...
        '{"p": "¿Cuál es la estancia mínima?", "p_de": "Wie lang ist die Mindestmietdauer?", "s": {"type": "multiple_choice", "options": ["Un mes", "Tres meses", "Seis meses"], "answer": 1}}'::jsonb,
        '{"p": "¿Qué cantidad se paga como depósito?", "p_de": "Wie hoch ist die Kaution?", "s": {"type": "multiple_choice", "options": ["140 libras", "560 libras", "200 libras"], "answer": 2}}'::jsonb
    ];
BEGIN
    ...
    VALUES (
        ...
        'reading',
        'accommodation',
        'Room for rent in a quiet flat near the city centre. The price is £140 per week or £560 per month. The deposit is £200. Water, electricity and Wi-Fi are included in the price. There are no extra charges for heating.

The flat is home to two other tenants. You will have your own bedroom with a bed, a desk, a wardrobe, and a window that looks onto the street. The kitchen and the bathroom are shared. The kitchen is well-equipped with a cooker, a fridge, and a microwave. The flat is on the third floor, and the building has no elevator.

The nearest bus stop is two minutes on foot. The city centre is about fifteen minutes away by bus.

House rules are simple: no smoking inside, no pets, and no loud music after 10 p.m. Visitors are welcome during the day but cannot stay overnight. The minimum stay is three months. The room is available from 1 June.

For more information or to arrange a viewing, please contact Anna.'
