...
BEGIN
    ...
    VALUES (v_path_id, 6580, 'en', 'speaking', 'tourism')RETURNING uuid INTO v_speaking_id;
    INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
    VALUES (v_speaking_id, 'es', 'Describir Summer Lights', '{"scenario": "Vas a describir el evento Summer Lights Concert.", "tasks": ["Di el nombre del evento.", "Di el lugar.", "Di el día.", "Di la hora de inicio.", "Di el precio.", "Nombra al primer artista o acto.", "Nombra al segundo artista o acto.", "Explica un detalle especial del evento."]}'::jsonb);
    INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
    VALUES (v_speaking_id, 'de', 'Lights Concert beschreiben', '{"scenario": "Du beschreibst die Veranstaltung Summer Lights Concert.", "tasks": ["Nenne den Namen der Veranstaltung.", "Nenne den Ort.", "Nenne den Tag.", "Nenne die Startzeit.", "Nenne den Preis.", "Nenne den ersten Künstler oder Programmpunkt.", "Nenne den zweiten Künstler oder Programmpunkt.", "Erkläre ein besonderes Detail der Veranstaltung."]}'::jsonb);
END; $seed$;
