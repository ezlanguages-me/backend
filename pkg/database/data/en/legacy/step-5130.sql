...
BEGIN
    ...
    VALUES (v_path_id, 5130, 'en', 'dialogue', 'academic', '[{"name": "Ana", "gender": "female", "avatarURL": "https://example.com/avatars/ana.png"}, {"name": "Jonas", "gender": "male", "avatarURL": "https://example.com/avatars/jonas.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES (v_dialogue_id, 'es', 'Simples sobre el trabajo');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES (v_dialogue_id, 'de', 'Meinungen über Gruppenarbeit');
