...
BEGIN
    ...
    VALUES (v_path_id, 5220, 'en', 'dialogue', 'academic', '[{"name": "Elena", "gender": "female", "avatarURL": "https://example.com/avatars/elena.png"}, {"name": "Pablo", "gender": "male", "avatarURL": "https://example.com/avatars/pablo.png"}]'::jsonb)RETURNING uuid INTO v_dialogue_id;

    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
    VALUES (v_dialogue_id, 'es', 'Temas de investigación');
    INSERT INTO dialogue_translation (dialogue_uuid, language, title)
