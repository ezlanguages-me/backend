...
BEGIN
  ...
  VALUES (v_path_uuid, 6140, 'en', 'speaking', 'accommodation')RETURNING uuid INTO v_speaking_uuid;
  INSERT INTO speaking_translation (speaking_uuid, language, title, prompt)
  VALUES (v_speaking_uuid, 'es', 'Pide reparaciones', '{"scenario": "Hay una avería en tu vivienda y necesitas pedir una reparación al propietario o al gestor.", "tasks": ["Saluda y explica el problema principal.", "Di dónde está la avería.", "Explica si es urgente o no.", "Menciona desde cuándo ocurre.", "Pregunta cuándo pueden venir a arreglarlo.", "Ofrece una hora para entrar en la vivienda.", "Pregunta si necesitas enviar fotos.", "Cierra agradeciendo la ayuda."]}'::jsonb), (v_speaking_uuid, 'de', 'Bitte um Reparaturen', '{"scenario": "Es gibt einen Schaden in deiner Wohnung und du musst den Eigentümer oder Verwalter um Reparatur bitten.", "tasks": ["Begrüße die Person und erkläre das Hauptproblem.", "Sag, wo der Schaden ist.", "Erkläre, ob es dringend ist oder nicht.", "Erwähne, seit wann das Problem besteht.", "Frage, wann jemand zur Reparatur kommen kann.", "Nenne eine Uhrzeit, zu der man in die Wohnung kommen kann.", "Frage, ob du Fotos schicken sollst.", "Schließe mit einem Dank für die Hilfe ab."]}'::jsonb);
END;
$seed$;
