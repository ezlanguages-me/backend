...
BEGIN
    ...
    VALUES (v_path_id, 7070, 'en', 'reading', 'phone_correspondence', 'Subject: Seville\n\nHi Luis,\nI am writing about Seville. The plan is for Friday at 16:00.\n\nWe can travel by train and meet at platform 3. Please bring the mobile tickets.\n\nPlease call again at 15:00,\nMarta')RETURNING uuid INTO v_reading_id;
    INSERT INTO reading_translation (reading_uuid, language, title) VALUES (v_reading_id, 'es', 'Consejos para llamadas');
    INSERT INTO reading_translation (reading_uuid, language, title) VALUES (v_reading_id, 'de', 'Tipps für Reiseanrufe');
