-- ============================================================
-- Seed: English Path – Step 0010 – Grammar
-- Title:       Los Números
-- Description: 
...
| Sesenta | Six**ty** | /**siks**-ti/ |
| Setenta | Seven**ty** | /**sé**-ven-ti/ |
| Ochenta | Eight**ty** | /**éit**-ti/ |
| Noventa | Nine**ty** | /**náin**-ti/ |
...
### Números Ordinales (Posición)
Indican orden. Casi todos terminan en **-th**.
- 1st: *First* (irregular)
- 2nd: *Second* (irregular)
- 3rd: *Third* (irregular)
- 4th: *Fourth* ... hasta 19th.
- 20th: *Twentieth* (cambia la y por ieth).
- 30th: *Thirtieth* (cambia la y por ieth).
- 31st: *Thirty-first* (compuesto, con guion y forma ordinal del número base).
- 100th: *One hundredth* (forma ordinal de "hundred", no "hundredth").
